...
public class NewtonRaphson{
	public static void main (String[] args){
		...
		if((funcaoOriginal(intervaloA)*segundaDerivada(intervaloA) > 0) && (primeiraDerivada(intervaloB)*segundaDerivada(intervaloB) > 0)){
		...
		}else if((funcaoOriginal(intervaloA)*segundaDerivada(intervaloA) > 0)){
		...
		}else if((funcaoOriginal(intervaloB)*segundaDerivada(intervaloB) > 0)){
